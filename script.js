...
gridContainer.addEventListener('click', (evento) => {
    ...
    if (currentTool === 'wall') {
        ...
        cella.dataset.sub = currentSubOption;
        cella.textContent = '🔑';
        if (currentSubOption === 'red') cella.style.backgroundColor = '#ff9999';
        if (currentSubOption === 'green') cella.style.backgroundColor = '#99ff99';
        if (currentSubOption === 'blue') cella.style.backgroundColor = '#99ccff';
        if (currentSubOption === 'yellow') cella.style.backgroundColor = '#ffff99';
            ...
            try {
                ...
                levelData.map.forEach(item => {
                    ...
                    if (cell) {
                      ...
                      if (item.type === 'key') {
                            cell.textContent = '🔑';
                            if (item.sub === 'red') cell.style.backgroundColor = '#ff9999';
                            if (item.sub === 'green') cell.style.backgroundColor = '#99ff99';
                            if (item.sub === 'blue') cell.style.backgroundColor = '#99ccff';
                            if (item.sub === 'yellow') cell.style.backgroundColor = '#ffff99';
                        }
                        if (item.type === 'lock') {
                            cell.textContent = '🔒';
                            if (item.sub === 'red') cell.style.backgroundColor = '#ff9999';
    ...
    editorCells.forEach(editorCell => {
        if (editorCell.dataset.type) {
           ...
           if (type === 'key') {
                ...
                if (sub === 'red') targetCell.style.backgroundColor = '#ff9999';
                if (sub === 'green') targetCell.style.backgroundColor = '#99ff99';
                if (sub === 'blue') targetCell.style.backgroundColor = '#99ccff';
                if (sub === 'yellow') targetCell.style.backgroundColor = '#ffff99';
            }
            if (type === 'lock') {
                targetCell.textContent = '🔒';
                if (sub === 'red') targetCell.style.backgroundColor = '#ff9999';
